package ObjectOrintedAssigments.Inheritance.AccountingProject.test;
...
public class CheckingAccountTest {
    ...
    public void test01_CheckingAccountClassWellFormed() {
        try {
            ...
            checkingAccountClass = Class.forName("ObjectOrintedAssigments.Inheritance.AccountingProject.main.CheckingAccount");
