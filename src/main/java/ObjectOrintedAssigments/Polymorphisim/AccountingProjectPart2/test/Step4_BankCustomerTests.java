...
import ObjectOrintedAssigments.Polymorphisim.AccountingProjectPart2.main.BankAccount;
import ObjectOrintedAssigments.Polymorphisim.AccountingProjectPart2.main.CheckingAccount;
import ObjectOrintedAssigments.Polymorphisim.AccountingProjectPart2.main.SavingsAccount;
...
public class Step4_BankCustomerTests {
    private final String PACKAGE_NAME = "ObjectOrintedAssigments.Polymorphisim.AccountingProjectPart2.main";
    ...
    private String classWellFormedCheck() {
        ...
        fieldCheck = ReflectionTestHelper.checkField(bankCustomerClass, "accounts", List.class, ReflectionTestHelper.AccessModifier.Private);
        if (!fieldCheck.isEmpty()) {
            return fieldCheck;
        }
